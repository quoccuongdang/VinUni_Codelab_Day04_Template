...
# Tool đọc product_catalog.json và lọc theo category, max_price.
# ---------------------------------------------------------------------------
...
# Tool tạo ticket mới và lưu vào support_tickets.json.
# ---------------------------------------------------------------------------
...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": "Tạo phiếu hỗ trợ cho khách hàng và lưu vào hệ thống.",
        "parameters": {
            "type": "object",
            "properties": {
                "customer_name": {
